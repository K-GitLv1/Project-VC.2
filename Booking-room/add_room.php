...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($uploadOk && move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO rooms (room_name, color, description, location, room_number, capacity, image, is_visible, created_at) 
                VALUES ('$room_name', '$color', '$description', '$location', '$room_number', $capacity, '$target_file', 1, now())";
