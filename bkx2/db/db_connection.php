...
// $username = "66309010034db"; // ชื่อผู้ใช้ฐานข้อมูล (ปกติใน XAMPP คือ root)
// $password = "66309010034"; // รหัสผ่าน (ปกติไม่มีรหัสผ่านใน XAMPP)
// $dbname = "66309010034db"; // ชื่อฐานข้อมูลที่คุณสร้าง
